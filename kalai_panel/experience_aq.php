...
<head>
	...
	<title>Experience: Academic Qualification - Academic Profile <?php echo $user_role;?></title>
        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="experience_aq.php">Experience: Academic Qualification</a>
                </div>
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-left">
                        <li>
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
								<p class="hidden-lg hidden-md">Experience: Academic Qualification</p>
                            </a>
                        </li>
                    </ul>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="experience_aq.php">Academic Qualification</a></li>
                            ...
                            <div class="header">
                                <h4 class="title">Experience: Academic Qualification</h4>
                            </div>
                            <div class="content table-responsive">
                                ...
                                <table id="tlist" class="table table-hover table-striped">
                                    <thead>
                                    	...
                                    	<th width="75%" style="text-align:center">Academic Title</th>
                                    	<th width="20%" style="text-align:center">Awarding University</th>
                                    ...
                                    <button type= "button" data-toggle="modal" data-target="#AddData" class="add-data btn btn-success btn-sm">+ Add New Experience</button>
                                        <?php
                                        $sql = mysqli_query($conn, "SELECT * from tbl_academic_qualification WHERE super_owner='$login_super_owner'");
                                        ...
                                        <tr>
                                        	...
                                        	<td><?php echo $row['academic_award_uni'];?></td>
                                            <td><?php echo $row['academic_date'];?></td>
                                            <td><button type="button" data-toggle="modal" data-id="<?php echo $row['id'];?>" data-title="<?php echo $row['academic_title'];?>" 
                                            data-award="<?php echo $row['academic_award_uni'];?>" data-date="<?php echo $row['academic_date'];?>" data-target="#EditData" class="edit-data btn btn-primary btn-sm">EDIT</button>
...
<div class="modal fade" id="AddData" role="dialog">
	<div class="modal-dialog">
    	...
    	<!-- Modal content-->
      	<div class="modal-content">
		  	<form id="adddata" name="adddata" method="post" enctype="multipart/form-data" action="operations/add-experience_aq.php">
        		<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="title" id="title" class="form-control" placeholder="Academic Title..." required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input type="text" name="award" id="award" class="form-control" placeholder="Awarding University..." required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Date/Year</label>
                                <input type="text" name="date" id="date" class="form-control" placeholder="Date/Year..." required>
                            </div>
                        </div>
                    </div>
...
<div class="modal fade" id="EditData" role="dialog">
	<div class="modal-dialog">
    	...
    	<!-- Modal content-->
      	<div class="modal-content">
		  	<form id="editdata" name="editdata" method="post" enctype="multipart/form-data" action="operations/edit-experience_aq.php">
        		<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
...
<!-- Confirm Delete Modal -->
  <div class="modal fade" id="ConfirmDelete" role="dialog">
    <div class="modal-dialog">
      ...
      <!-- Modal content-->
      <div class="modal-content">
        <form action="operations/delete-experience_aq.php" method="post" class="form-horizontal" enctype="multipart/form-data">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
	...
	<script type="text/javascript">
    	$(document).ready(function(){
        	...
        	$(document).on("click", ".edit-data", function () {
				...
				var dateTitle = $(this).data('title');
                var dataAward = $(this).data('award');
                var dataDate = $(this).data('date');
                $(".modal-body #oldid").val( dataId );
				$(".modal-body #title").val( dateTitle );
                $(".modal-body #award").val( dataAward );

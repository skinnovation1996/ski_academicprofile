...
<head>
	...
	<title>Experience: Career History - Academic Profile <?php echo $user_role;?></title>
        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="experience_ch.php">Experience: Career History</a>
                </div>
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-left">
                        <li>
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
								<p class="hidden-lg hidden-md">Experience: Career History</p>
                            </a>
                        </li>
                    </ul>
                            ...
                            <div class="content table-responsive">
                                ...
                                <table id="tlist" class="table table-hover table-striped">
                                    <thead>
                                    	...
                                    	<th width="65%" style="text-align:center">Career Title</th>
                                    	<th width="20%" style="text-align:center">Organization</th>
                                    ...
                                    <button type= "button" data-toggle="modal" data-target="#AddData" class="add-data btn btn-success btn-sm">+ Add New Experience</button>
                                        <?php
                                        $sql = mysqli_query($conn, "SELECT * from tbl_career_history WHERE super_owner='$login_super_owner' ORDER BY id DESC");
                                        ...
                                        <tr>
                                        	...
                                        	<td><?php echo $row['career_title'];?></td>
                                        	<td><?php echo $row['career_organization'];?></td>
                                            <td><?php echo $row['career_startdate'];?></td>
                                            <td><?php echo $row['career_enddate'];?></td>
                                            <td><button type="button" data-toggle="modal" data-id="<?php echo $row['id'];?>" data-title="<?php echo $row['career_title'];?>" 
                                            data-organization="<?php echo $row['career_organization'];?>" data-startdate="<?php echo $row['career_startdate'];?>" data-enddate="<?php echo $row['career_enddate'];?>" data-target="#EditData" class="edit-data btn btn-primary btn-sm">EDIT</button>
...
<div class="modal fade" id="AddData" role="dialog">
	<div class="modal-dialog">
    	...
    	<!-- Modal content-->
      	<div class="modal-content">
		  	<form id="adddata" name="adddata" method="post" enctype="multipart/form-data" action="operations/add-experience_ch.php">
        		<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
...
<div class="modal fade" id="EditData" role="dialog">
	<div class="modal-dialog">
    	...
    	<!-- Modal content-->
      	<div class="modal-content">
		  	<form id="editdata" name="editdata" method="post" enctype="multipart/form-data" action="operations/edit-experience_ch.php">
        		<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
...
<!-- Confirm Delete Modal -->
  <div class="modal fade" id="ConfirmDelete" role="dialog">
    <div class="modal-dialog">
      ...
      <!-- Modal content-->
      <div class="modal-content">
        <form action="operations/delete-experience_ch.php" method="post" class="form-horizontal" enctype="multipart/form-data">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
	...
	<script type="text/javascript">
    	$(document).ready(function(){
        	...
        	$(document).on("click", ".edit-data", function () {
                ...
                var dataOrganization = $(this).data('organization');
                ...
                $(".modal-body #organization").val( dataOrganization );

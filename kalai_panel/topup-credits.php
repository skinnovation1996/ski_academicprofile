...
<head>
	...
	<title>Reload Credits - Academic Profile <?php echo $user_role;?></title>
        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="my-credits.php"><<</a><a class="navbar-brand" href="topup-credits.php">Reload Credits</a>
                </div>
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-left">
                        <li>
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
								<p class="hidden-lg hidden-md">Reload Credits</p>
                            </a>
                        </li>
                    </ul>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Reload Credits</h4>
                                <p class="category">Use credits to add/edit your profile information.</p>
                            </div>
                            <div class="content table-responsive">
                                <?php if($successmsg != NULL){ ?>
                                    ...
                                    <?php } ?>
                                <form id="adddata" name="adddata" method="post" enctype="multipart/form-data" action="operations/topup-credits.php">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Credits</label>
                                                <select name="credits" id="credits" class="form-control">
                                                    <option value="100">100 Credits (RM0.00)</option>
                                                    <option value="200">200 Credits (RM0.00)</option>
                                                    <option value="500">500 Credits (RM0.00)</option>
                                                    <option value="1000">1000 Credits (RM0.00)</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-3">

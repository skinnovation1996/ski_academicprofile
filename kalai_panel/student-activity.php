...
<head>
	...
	<title>Student Activity - Academic Profile Student</title>
...
<div class="wrapper">
    ...
    -->
    	...
    	<div class="sidebar-wrapper">
            ...
            <?php $navactive = 9; include("assets/php/Student-navbar.php");?>
    	</div>
    </div>
        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="student-activity.php">Student Activity</a>
                </div>
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-left">
                        <li>
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
								<p class="hidden-lg hidden-md">Student Activity</p>
                            </a>
                        </li>
                    </ul>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Student Activity</h4>
                                <p>Select Community Involvement</p>
                            </div>
                            <div class="content table-responsive">
                                <?php if($successmsg != NULL){ ?>
                                    ...
                                    <?php } 
                                    $sqla = mysqli_query($conn, "SELECT std_activity from tbl_students WHERE std_reg_num='$login_session' AND super_owner='$login_super_owner'"); 
                                    $row=mysqli_fetch_assoc($sqla);
                                    $std_activity = $row['std_activity'];
                                    ?>
                                    <form id="selectactivity" name="selectactivity" method="post" enctype="multipart/form-data" action="operations/select-activity.php">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label>Your Chosen Student Activity</label>
                                                    <select name="activity" id="activity" class="form-control">
                                                        <option value="Not Specified">Not Specified</option>    
                                                        <?php 
                                                        $sql2 = mysqli_query($conn, "SELECT * from tbl_community WHERE super_owner='$login_super_owner'");
                                                        while($row2=mysqli_fetch_assoc($sql2)){
                                                            $programTitle = $row2['program_title'];
                                                            $category = $row2['category'];
                                                            echo "<option value='$programTitle'";
                                                            if($programTitle == $std_activity){
                                                                echo " selected='selected'";
                                                            }
                                                            echo ">$programTitle ($category)</option>";
                                                        }?>
                                                    </select>
                                                </div>
                                            </div>

...
<head>
	...
	<title>Students: Masters - Academic Profile <?php echo $user_role;?></title>
        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="students_masters.php">Students: Masters</a>
                </div>
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-left">
                        <li>
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
								<p class="hidden-lg hidden-md">Students: Masters</p>
                            </a>
                        </li>
                    </ul>
                            ...
                            <div class="content table-responsive">
                                ...
                                <table id="tlist" class="table table-hover table-striped">
                                    ...
                                    <a href="add-student.php" role="button" class="add-data btn btn-success btn-sm">+ Add New Student</a>
                                        <?php
                                        $sql = mysqli_query($conn, "SELECT * from tbl_students WHERE std_type='1' AND super_owner='$login_super_owner' ORDER BY std_name");

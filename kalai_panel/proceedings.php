...
<head>
	...
	<title>Proceedings - Academic Profile <?php echo $user_role;?></title>
...
<div class="wrapper">
    ...
    -->
    	...
    	<div class="sidebar-wrapper">
            ...
            <?php $navactive = 6; include("assets/php/$navbar");?>
    	</div>
    </div>
        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="proceedings.php">Proceedings</a>
                </div>
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-left">
                        <li>
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
								<p class="hidden-lg hidden-md">Proceedings</p>
                            </a>
                        </li>
                    </ul>
                            ...
                            <div class="content table-responsive">
                                ...
                                <table id="tlist" class="table table-hover table-striped">
                                    <thead>
                                    	...
                                    	<th width="45%" style="text-align:center">Proceeding Title</th>
                                        <th width="40%" style="text-align:center">Authors</th>
                                        <th width="10%" style="text-align:center">Year</th>
                                        <th width="10%" style="text-align:center">Actions</th>
                                    </thead>
                                    <tbody>
                                    <button type= "button" data-toggle="modal" data-target="#AddData" class="add-data btn btn-success btn-sm">+ Add New Proceeding</button>
                                        <?php
                                        if($user_role != "Student"){
                                            $sql = mysqli_query($conn, "SELECT * from tbl_proceedings WHERE super_owner='$login_super_owner' ORDER BY proceeding_year DESC");
                                        }else if($user_role == "Student"){
                                            $sql = mysqli_query($conn, "SELECT * from tbl_proceedings WHERE proceeding_owner='$login_session' AND super_owner='$login_super_owner' ORDER BY proceeding_year DESC");
                                        }
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $row['proceeding_year'];?></td>
                                            <td><button type="button" data-toggle="modal" data-id="<?php echo $row['id'];?>" data-authors="<?php echo $authorsinput;?>" data-title="<?php echo $row['proceeding_title'];?>" 
                                            data-year="<?php echo $row['proceeding_year'];?>" data-conferencename="<?php echo $row['conference_name'];?>" data-conferencelocation="<?php echo $row['conference_location'];?>"
                                            data-conferencedate="<?php echo $row['conference_date'];?>" data-volume="<?php echo $row['proceeding_volume'];?>" data-pagenum="<?php echo $row['proceeding_pagenum'];?>" 
                                            data-owner="<?php echo $row['proceeding_owner'];?>" data-file="<?php echo $row['proceeding_file'];?>" data-target="#EditData" class="edit-data btn btn-primary btn-sm">EDIT</button>
                                            <a class="btn btn-success btn-sm" role="button"
                                            <?php 
                                            if($row['proceeding_file'] == NULL){ 
                                                echo "disabled";
                                            }
                                            else{
                                                $file = $row['proceeding_file'];
                                                echo "href='uploads/proceedings/$file'";
                                            }
                                            ?>>DOWNLOAD</a>
...
<div class="modal fade" id="AddData" role="dialog">
	<div class="modal-dialog">
    	...
    	<!-- Modal content-->
      	<div class="modal-content">
		  	<form id="adddata" name="adddata" method="post" enctype="multipart/form-data" action="operations/add-proceeding.php">
        		<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
					<h4 class="modal-title">Add Proceeding</h4>
                    <p class="category">For each proceeding added, 10 credits will be deducted from your credit balance.</p>
				</div>
				<div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Proceeding Title (HTML Tags Allowed)</label>
                                <input type="text" name="title" id="title" class="form-control" placeholder="Proceeding Title..." required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="conference_name" id="conference_name" class="form-control" placeholder="Conference Name..." required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Proceeding Year</label>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Conference Location (optional)</label>
                                <input type="text" name="conference_location" id="conference_location" class="form-control" placeholder="Conference Location...">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Conference Date (optional)</label>
                                <input type="text" name="conference_date" id="conference_date" class="form-control" placeholder="Conference Date...">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="file" name="proceedingfile" id="proceedingfile">
                            </div>
                        </div>
                    </div>
...
<div class="modal fade" id="EditData" role="dialog">
	<div class="modal-dialog">
    	...
    	<!-- Modal content-->
      	<div class="modal-content">
		  	<form id="editdata" name="editdata" method="post" enctype="multipart/form-data" action="operations/edit-proceeding.php">
        		<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
					<h4 class="modal-title">Edit Proceeding</h4>
				</div>
				<div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
...
<!-- Confirm Delete Modal -->
  <div class="modal fade" id="ConfirmDelete" role="dialog">
    <div class="modal-dialog">
      ...
      <!-- Modal content-->
      <div class="modal-content">
        <form action="operations/delete-proceeding.php" method="post" class="form-horizontal" enctype="multipart/form-data">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Are You Sure?</h4>
        </div>
        <div class="modal-body">
          <p>WARNING! Are you sure to delete this proceeding?</p>
          <input type="hidden" name="oldid" id="oldid" value=""/>
        </div>
        <div class="modal-footer">
	...
	<script type="text/javascript">
    	$(document).ready(function(){
        	...
        	$(document).on("click", ".edit-data", function () {
                ...
                var dataConferenceName = $(this).data('conferencename');
                var dataConferenceLocation = $(this).data('conferencelocation');
                var dataConferenceDate = $(this).data('conferencedate');
                ...
                $(".modal-body #conference_name").val( dataConferenceName );
                $(".modal-body #conference_location").val( dataConferenceLocation );
                $(".modal-body #conference_date").val( dataConferenceDate );

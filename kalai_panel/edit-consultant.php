...
$sqla = mysqli_query($conn, "SELECT * from tbl_admin WHERE id='$sqlgetid' AND role='Consultant' AND admin_id NOT LIKe 'super_admin'"); 
...
<head>
	...
	<title>Edit Consultant - Academic Profile Super Admin</title>
        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="consultants.php"><<</a><a class="navbar-brand" href="edit-consultant.php?id=<?php echo $sqlgetid;?>">Edit Consultant</a>
                </div>
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-left">
                        <li>
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
								<p class="hidden-lg hidden-md">Edit Consultant</p>
                            </a>
                        </li>
                    </ul>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Edit Consultant</h4>
                            </div>
                            <div class="content table-responsive">
                                <?php if($successmsg != NULL){ ?>
                                    ...
                                    <?php } ?>
                                <form id="adddata" name="adddata" method="post" enctype="multipart/form-data" action="operations/edit-consultant.php">
                                    <div class="row">
                                        <div class="col-md-4">

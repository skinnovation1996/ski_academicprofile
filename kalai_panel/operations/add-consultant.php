...
if(isset($_POST['submit-button'])){
    ...
    if($rows != NULL){
        ...
        header("location:../add-consultant.php");
    }
    $name = mysqli_real_escape_string($conn,$_POST['name']);
    $role = mysqli_real_escape_string($conn,"Consultant");
    ...
    if($errorCode == NULL){
        ...
        $_SESSION['academicprofile_success_msg'] = "You have successfully added the consultant! An email has been sent to the consultant for logging in to the system.";

...
if(isset($_POST['delete-button'])){
    ...
    if($errorCode == NULL){
        ...
        $query = "DELETE FROM tbl_teaching WHERE id='$sqlgetid' AND super_owner='$super_owner'";
    ...
    if($errorCode == NULL){
        ...
        $_SESSION['academicprofile_success_msg'] = "You have successfully removed the course!";

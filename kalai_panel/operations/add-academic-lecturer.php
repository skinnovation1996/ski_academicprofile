...
if(isset($_POST['submit-button'])){
    ...
    if($rows != NULL){
        ...
        header("location:../add-academic-lecturer.php");
    }
    $name = mysqli_real_escape_string($conn,$_POST['name']);
    $role = mysqli_real_escape_string($conn,"Academic Lecturer");
    ...
    if($errorCode == NULL){
        ...
        $_SESSION['academicprofile_success_msg'] = "You have successfully added the academic lecturer! An email has been sent to the academic lecturer for logging in to the system.";

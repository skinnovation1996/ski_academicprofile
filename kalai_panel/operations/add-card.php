...
if(isset($_POST['submit-button'])){
    ...
    if($errorCode == NULL){
        ...
        $query = "INSERT INTO tbl_cards (admin_id, card_num, cvv, expiry_date, type)
        VALUES ('$owner','$card_num','$cvv','$expiry_date','$type')";
    ...
    if($errorCode == NULL){
        $_SESSION['academicprofile_success_msg'] = "You have successfully added your payment card!";

...
if(isset($_POST['delete-button'])){
    ...
    $sql = mysqli_query($conn, "SELECT * from tbl_bookchapters WHERE id='$sqlgetid' AND super_owner='$super_owner'");
    $row = mysqli_fetch_array($sql);
    $old_file = $row['chapter_file'];

    if($errorCode == NULL){

        $query = "DELETE FROM tbl_bookchapters WHERE id='$sqlgetid' AND super_owner='$super_owner'";
    ...
    if($errorCode == NULL){
        ...
        $_SESSION['academicprofile_success_msg'] = "You have successfully removed the book chapter!";

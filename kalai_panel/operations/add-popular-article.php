...
if(isset($_POST['submit-button'])){
    ...
    if($errorCode == NULL){
        ...
        $query = "INSERT INTO tbl_popular_article (article_platform, article_title, article_author,
        article_file, article_owner, super_owner) VALUES ('$platform','$title','$author','$file_uploaded','$owner','$super_owner')";
    ...
    if($errorCode == NULL){
        $_SESSION['academicprofile_success_msg'] = "You have successfully added your popular article!";

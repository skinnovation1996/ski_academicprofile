...
<head>
	...
	<title>Manage Academic Lecturers - Academic Profile Super Admin</title>
        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="academic-lecturers.php">Manage Academic Lecturers</a>
                </div>
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-left">
                        <li>
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
								<p class="hidden-lg hidden-md">Manage Academic Lecturers</p>
                            </a>
                        </li>
                    </ul>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Manage Academic Lecturers</h4>
                            </div>
                            <div class="content table-responsive">
                                ...
                                <table id="tlist" class="table table-hover table-striped">
                                    ...
                                    <tbody>
                                    <a href="add-academic-lecturer.php" role="button" class="add-data btn btn-success btn-sm">+ Add New Academic Lecturer</a>
                                        <?php
                                        $sql = mysqli_query($conn, "SELECT * from tbl_admin WHERE role='Academic Lecturer' AND admin_id NOT LIKE 'super_admin'");
                                        ...
                                        <tr>
                                            ...
                                            <td>Associate Professor <?php //tba ?></td>
                                            ...
                                            echo $numStudents;
                                            ?></td>
                                            <td><a href="edit-academic-lecturer.php?id=<?php echo $row['id'];?>" class="btn btn-primary btn-sm" role="button">EDIT</a>
...
<!-- Confirm Delete Modal -->
  <div class="modal fade" id="ConfirmDelete" role="dialog">
    <div class="modal-dialog">
      ...
      <!-- Modal content-->
      <div class="modal-content">
        <form action="operations/delete-academic-lecturer.php" method="post" class="form-horizontal" enctype="multipart/form-data">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>

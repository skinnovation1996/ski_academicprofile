...
<head>
	...
	<title>Add Consultant - Academic Profile Super Admin</title>
        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="consultants.php"><<</a><a class="navbar-brand" href="add-consultant.php">Add New Consultant</a>
                </div>
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-left">
                        <li>
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
								<p class="hidden-lg hidden-md">Add New Consultant</p>
                            </a>
                        </li>
                    </ul>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Add New Consultant</h4>
                            </div>
                            <div class="content table-responsive">
                                <?php if($successmsg != NULL){ ?>
                                    ...
                                    <?php } ?>
                                <form id="adddata" name="adddata" method="post" enctype="multipart/form-data" action="operations/add-consultant.php">
                                    <div class="row">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="plan" id="plan" class="form-control">
                                                    <?php $sql2 = mysqli_query($conn, "select * from tbl_plans WHERE plan_type='Consultant'");

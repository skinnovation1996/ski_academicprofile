...
<head>
	...
	<title>Knowledge - Academic Profile <?php echo $user_role;?></title>
...
<div class="wrapper">
    ...
    -->
    	...
    	<div class="sidebar-wrapper">
            ...
            <?php $navactive = 10; include("assets/php/Admin-navbar.php");?>
    	</div>
    </div>
                    ...
                    <ul class="nav navbar-nav navbar-left">
                        <li>
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
								<p class="hidden-lg hidden-md">Knowledge</p>
                            </a>
                        </li>
                    </ul>
                            ...
                            <div class="content table-responsive">
                                ...
                                <table id="tlist" class="table table-hover table-striped">
                                    <thead>
                                    	...
                                    	<th width="45%" style="text-align:center">Theme</th>
                                        <th width="40%" style="text-align:center">Title</th>
                                        <th width="10%" style="text-align:center">Date</th>
                                        <th width="10%" style="text-align:center">Actions</th>
                                    </thead>
                                    <tbody>
                                    <button type= "button" data-toggle="modal" data-target="#AddData" class="add-data btn btn-success btn-sm">+ Add New Knowledge</button>
                                        <?php
                                        $sql = mysqli_query($conn, "SELECT * from tbl_knowledge WHERE super_owner='$login_super_owner' ORDER BY knowledge_date");
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $row['knowledge_title'];?></td>
                                            <td><?php echo $row['knowledge_date'];?></td>
                                            <td><button type="button" data-toggle="modal" data-id="<?php echo $row['id'];?>" data-title="<?php echo $row['knowledge_title'];?>" data-theme="<?php echo $row['knowledge_theme'];?>" 
                                            data-date="<?php echo $row['knowledge_date'];?>" data-notes="<?php echo $row['knowledge_notes'];?>" data-target="#EditData" class="edit-data btn btn-primary btn-sm">EDIT</button>
...
<div class="modal fade" id="AddData" role="dialog">
	<div class="modal-dialog">
    	...
    	<!-- Modal content-->
      	<div class="modal-content">
		  	<form id="adddata" name="adddata" method="post" enctype="multipart/form-data" action="operations/add-knowledge.php">
        		<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
					<h4 class="modal-title">Add Knowledge</h4>
                    <p class="category">For each knowledge added, 10 credits will be deducted from your credit balance.</p>
				</div>
				<div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Theme</label>
                                <input type="text" name="theme" id="theme" class="form-control" placeholder="Theme..." required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Notes</label>
                                <textarea name="notes" id="notes" class="form-control" placeholder="Notes..." required columns="3" rows="3"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Date</label>
                                <input type="date" name="date" id="date" class="form-control" value="<?php echo date("Y-m-d");?>" readonly required>
                            </div>
                        </div>
                    </div>
...
<div class="modal fade" id="EditData" role="dialog">
	<div class="modal-dialog">
    	...
    	<!-- Modal content-->
      	<div class="modal-content">
		  	<form id="editdata" name="editdata" method="post" enctype="multipart/form-data" action="operations/edit-knowledge.php">
        		<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
					<h4 class="modal-title">Edit Knowledge</h4>
				</div>
				<div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
...
<!-- Confirm Delete Modal -->
  <div class="modal fade" id="ConfirmDelete" role="dialog">
    <div class="modal-dialog">
      ...
      <!-- Modal content-->
      <div class="modal-content">
        <form action="operations/delete-knowledge.php" method="post" class="form-horizontal" enctype="multipart/form-data">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Are You Sure?</h4>
        </div>
        <div class="modal-body">
          <p>WARNING! Are you sure to delete this knowledge?</p>
          <input type="hidden" name="oldid" id="oldid" value=""/>
        </div>
        <div class="modal-footer">

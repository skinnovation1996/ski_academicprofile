...
<head>
	...
	<title>Interests - Academic Profile <?php echo $user_role;?></title>
...
<div class="wrapper">
    ...
    -->
    	...
    	<div class="sidebar-wrapper">
            ...
            <?php $navactive = 11; include("assets/php/Admin-navbar.php");?>
    	</div>
    </div>
        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="interests.php">Interests</a>
                </div>
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-left">
                        <li>
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
								<p class="hidden-lg hidden-md">Interests</p>
                            </a>
                        </li>
                    </ul>
                            ...
                            <div class="content table-responsive">
                                ...
                                <table id="tlist" class="table table-hover table-striped">
                                    <thead>
                                        ...
                                        <th width="85%" style="text-align:center">Title</th>
                                        <th width="10%" style="text-align:center">Actions</th>
                                    </thead>
                                    <tbody>
                                    <button type= "button" data-toggle="modal" data-target="#AddData" class="add-data btn btn-success btn-sm">+ Add New Interest</button>
                                        <?php
                                        $sql = mysqli_query($conn, "SELECT * from tbl_interest WHERE super_owner='$login_super_owner'");
                                        $rows = mysqli_num_rows($sql);
                                              
                                        if($rows){
                                            $count = 1;
                                            while($row=mysqli_fetch_array($sql)){
                                                switch($row['interest_category']){
                                                    case 0:
                                                        $category = "Academic";
                                                        break;
                                                    case 1:
                                        ...
                                        <tr>
                                            ...
                                            <td><?php 
                                            if($row['interest_file'] != NULL){
                                            ?><a href="uploads/interests/<?php echo $row['interest_file'];?>" target="_new"><b><?php echo $row['interest_title'];?></b></a>
                                            <?php
                                            }else{
                                                echo "<b>".$row['interest_title']."</b>";
                                            }?></td>
                                            <td><button type="button" data-toggle="modal" data-id="<?php echo $row['id'];?>" data-title="<?php echo $row['interest_title'];?>" data-category="<?php echo $row['interest_category'];?>" 
                                            data-notes="<?php echo $row['interest_notes'];?>" data-file="<?php echo $row['interest_file'];?>" data-target="#EditData" class="edit-data btn btn-primary btn-sm">EDIT</button>
...
<div class="modal fade" id="AddData" role="dialog">
	<div class="modal-dialog">
    	...
    	<!-- Modal content-->
      	<div class="modal-content">
		  	<form id="adddata" name="adddata" method="post" enctype="multipart/form-data" action="operations/add-interest.php">
        		<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
					<h4 class="modal-title">Add Interest</h4>
                    <p class="category">For each interest added, 5 credits (10 credits with file) will be deducted from your credit balance.</p>
				</div>
				<div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="file" name="interestfile" id="interestfile">
                            </div>
                        </div>
                    </div>
...
<div class="modal fade" id="EditData" role="dialog">
	<div class="modal-dialog">
    	...
    	<!-- Modal content-->
      	<div class="modal-content">
		  	<form id="editdata" name="editdata" method="post" enctype="multipart/form-data" action="operations/edit-interest.php">
        		<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
					<h4 class="modal-title">Edit Interest</h4>
				</div>
				<div class="modal-body">
                <div class="row">
                        <div class="col-md-12">
...
<!-- Confirm Delete Modal -->
  <div class="modal fade" id="ConfirmDelete" role="dialog">
    <div class="modal-dialog">
      ...
      <!-- Modal content-->
      <div class="modal-content">
        <form action="operations/delete-interest.php" method="post" class="form-horizontal" enctype="multipart/form-data">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Are You Sure?</h4>
        </div>
        <div class="modal-body">
          <p>WARNING! Are you sure to delete this interest?</p>
          <input type="hidden" name="oldid" id="oldid" value=""/>
        </div>
        <div class="modal-footer">

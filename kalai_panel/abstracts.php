...
<head>
	...
	<title>Abstracts - Academic Profile Student</title>
...
<div class="wrapper">
    ...
    -->
    	...
    	<div class="sidebar-wrapper">
            ...
            <?php $navactive = 3; include("assets/php/Student-navbar.php");?>
    	</div>
    </div>
        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="abstracts.php">Abstracts</a>
                </div>
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-left">
                        <li>
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
								<p class="hidden-lg hidden-md">Abstracts</p>
                            </a>
                        </li>
                    </ul>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Abstracts</h4>
                                <p class="category">For each abstract added, 10 credits will be deducted from your credit balance.</p>
                            </div>
                            <div class="content table-responsive">
                                ...
                                <table id="tlist" class="table table-hover table-striped">
                                    ...
                                    <tbody>
                                    <button type= "button" data-toggle="modal" data-target="#AddData" class="add-data btn btn-success btn-sm">+ Add New Abstract</button>
                                        <?php
                                        $sql = mysqli_query($conn, "SELECT * from tbl_abstract WHERE abstract_owner='$login_session' AND super_owner='$login_super_owner'");
                                        ...
                                        <tr>
										    ...
										    <td><?php echo $row['abstract_stdname'];?></td>
                                            <td><button type="button" data-toggle="modal" data-id="<?php echo $row['id'];?>" data-title="<?php echo $row['abstract_title'];?>" data-author="<?php echo $row['abstract_stdname'];?>" 
                                            data-file="<?php echo $row['abstract_file'];?>" data-target="#EditData" class="edit-data btn btn-primary btn-sm">EDIT</button>
                                            <a class="btn btn-success btn-sm" role="button"
                                            <?php 
                                            if($row['abstract_file'] == NULL){ 
                                                echo "disabled";
                                            }
                                            else{
                                                $file = $row['abstract_file'];
                                                echo "href='uploads/abstracts/$file'";
                                            }
                                            ?>>DOWNLOAD</a>
...
<div class="modal fade" id="AddData" role="dialog">
	<div class="modal-dialog">
    	...
    	<!-- Modal content-->
      	<div class="modal-content">
		  	<form id="adddata" name="adddata" method="post" enctype="multipart/form-data" action="operations/add-abstract.php">
        		<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
					<h4 class="modal-title">Add Abstract</h4>
				</div>
				<div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Abstract Title (HTML tags allowed)</label>
                                <input type="text" name="title" id="title" class="form-control" placeholder="Abstract Title..." required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="file" name="abstractfile" id="abstractfile" required>
                            </div>
                        </div>
                    </div>
...
<div class="modal fade" id="EditData" role="dialog">
	<div class="modal-dialog">
    	...
    	<!-- Modal content-->
      	<div class="modal-content">
		  	<form id="editdata" name="editdata" method="post" enctype="multipart/form-data" action="operations/edit-abstract.php">
        		<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
...
<!-- Confirm Delete Modal -->
  <div class="modal fade" id="ConfirmDelete" role="dialog">
    <div class="modal-dialog">
      ...
      <!-- Modal content-->
      <div class="modal-content">
        <form action="operations/delete-abstract.php" method="post" class="form-horizontal" enctype="multipart/form-data">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Are You Sure?</h4>
        </div>
        <div class="modal-body">
          <p>WARNING! Are you sure to delete this abstract?</p>
          <input type="hidden" name="oldid" id="oldid" value=""/>
        </div>
        <div class="modal-footer">

...
<head>
	...
	<title>Students: Research Team Members - Academic Profile <?php echo $user_role;?></title>
        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="students_research.php">Students: Research Team Members</a>
                </div>
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-left">
                        <li>
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
								<p class="hidden-lg hidden-md">Students: Research Team Members</p>
                            </a>
                        </li>
                    </ul>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <ul class="nav nav-tabs">
                                <li><a href="students_ug.php">Undergraduates</a></li>
                                <li><a href="students_masters.php">Masters</a></li>
                                <li><a href="students_phd.php">PhD</a></li>
                                <li class="active"><a href="students_research.php">Research Team Members</a></li>
                            </ul>
                            <div class="header">
                                <h4 class="title">Students: Research Team Members</h4>
                            </div>
                            <div class="content table-responsive">
                                ...
                                <table id="tlist" class="table table-hover table-striped">
                                    ...
                                    <a href="add-student.php" role="button" class="add-data btn btn-success btn-sm">+ Add New Student</a>
                                        <?php
                                        $sql = mysqli_query($conn, "SELECT * from tbl_students WHERE std_type='4' AND super_owner='$login_super_owner' ORDER BY std_name");
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <input type="hidden" name="stdtype" id="stdtype" value="1"/>
        </div>
        <div class="modal-footer">

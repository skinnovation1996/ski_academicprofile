...
<head>
	...
	<title>Experience: Administrative Appointment - Academic Profile <?php echo $user_role;?></title>
        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="experience_aa.php">Experience: Administrative Appointment</a>
                </div>
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-left">
                        <li>
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
								<p class="hidden-lg hidden-md">Experience: Administrative Appointment</p>
                            </a>
                        </li>
                    </ul>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <ul class="nav nav-tabs">
                                ...
                                <li class="active"><a href="experience_aa.php">Administrative Appointment</a></li>
                                <li><a href="experience_sa.php">Scholarly Activities</a></li>
                            </ul>
                            <div class="header">
                                <h4 class="title">Experience: Administrative Appointment</h4>
                            </div>
                            <div class="content table-responsive">
                                ...
                                <table id="tlist" class="table table-hover table-striped">
                                    <thead>
                                    	...
                                    	<th width="75%" style="text-align:center">Appointment Position</th>
                                    ...
                                    <button type= "button" data-toggle="modal" data-target="#AddData" class="add-data btn btn-success btn-sm">+ Add New Experience</button>
                                        <?php
                                        $sql = mysqli_query($conn, "SELECT * from tbl_admin_appointment WHERE super_owner='$login_super_owner' ORDER BY id DESC");
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $row['admin_startdate'];?></td>
                                            <td><?php echo $row['admin_enddate'];?></td>
                                            <td><button type="button" data-toggle="modal" data-id="<?php echo $row['id'];?>" data-position="<?php echo $row['admin_position'];?>" 
                                            data-startdate="<?php echo $row['admin_startdate'];?>" data-enddate="<?php echo $row['admin_enddate'];?>" data-target="#EditData" class="edit-data btn btn-primary btn-sm">EDIT</button>
...
<div class="modal fade" id="AddData" role="dialog">
	<div class="modal-dialog">
    	...
    	<!-- Modal content-->
      	<div class="modal-content">
		  	<form id="adddata" name="adddata" method="post" enctype="multipart/form-data" action="operations/add-experience_aa.php">
        		<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Appointment Position</label>
                                <input type="text" name="position" id="position" class="form-control" placeholder="Appointment Position..." required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
...
<div class="modal fade" id="EditData" role="dialog">
	<div class="modal-dialog">
    	...
    	<!-- Modal content-->
      	<div class="modal-content">
		  	<form id="editdata" name="editdata" method="post" enctype="multipart/form-data" action="operations/edit-experience_aa.php">
        		<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
...
<!-- Confirm Delete Modal -->
  <div class="modal fade" id="ConfirmDelete" role="dialog">
    <div class="modal-dialog">
      ...
      <!-- Modal content-->
      <div class="modal-content">
        <form action="operations/delete-experience_aa.php" method="post" class="form-horizontal" enctype="multipart/form-data">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
	...
	<script type="text/javascript">
    	$(document).ready(function(){
        	...
        	$(document).on("click", ".edit-data", function () {
				...
				$(".modal-body #position").val( dataPosition );

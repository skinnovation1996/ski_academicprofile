...
<head>
	...
	<title>My Subscription Plan - Academic Profile <?php echo $user_role;?></title>
        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="my-plans.php">My Subscription Plans</a>
                </div>
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-left">
                        <li>
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
								<p class="hidden-lg hidden-md">My Subscription Plans</p>
                            </a>
                        </li>
                    </ul>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <ul class="nav nav-tabs">
                                ...
                                <li class="active"><a href="my-plans.php">My Subscription Plan</a></li>
                                <li><a href="my-cards.php">My Payment Cards</a></li>
                            </ul>
                            <div class="header">
                                <h4 class="title">My Subscription Plan</h4>
                            </div>

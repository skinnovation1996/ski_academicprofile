...
<head>
	...
	<title>Scholarly Types - Academic Profile <?php echo $user_role;?></title>
        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="experience_sa.php"><<</a><a class="navbar-brand" href="scholarly_types.php">Scholarly Types</a>
                </div>
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-left">
                        <li>
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
								<p class="hidden-lg hidden-md">Scholarly Types</p>
                            </a>
                        </li>
                    </ul>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Scholarly Types</h4>
                            </div>
                            <div class="content table-responsive">
                                ...
                                <table id="tlist" class="table table-hover table-striped">
                                    <thead>
                                    	...
                                    	<th width="85%" style="text-align:center">Scholarly Type</th>
                                        <th width="10%" style="text-align:center">Actions</th>
                                    </thead>
                                    <tbody>
                                    <button type= "button" data-toggle="modal" data-target="#AddData" class="add-data btn btn-success btn-sm">+ Add New Scholarly Type</button>
                                        <?php
                                        $sql = mysqli_query($conn, "SELECT * from tbl_scholarly_types WHERE super_owner='$login_super_owner'");
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $row['scholarly_type_title'];?></td>
                                            <td><button type="button" data-toggle="modal" data-id="<?php echo $row['id'];?>" data-title="<?php echo $row['scholarly_type_title'];?>" 
...
<div class="modal fade" id="AddData" role="dialog">
	<div class="modal-dialog">
    	...
    	<!-- Modal content-->
      	<div class="modal-content">
		  	<form id="adddata" name="adddata" method="post" enctype="multipart/form-data" action="operations/add-scholarly-type.php">
        		<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
					<h4 class="modal-title">Add Scholarly Type</h4>
				</div>
				<div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Scholarly Type</label>
                                <input type="text" name="title" id="title" class="form-control" placeholder="Scholarly Type..." required>
                            </div>
                        </div>
                    </div>
...
<div class="modal fade" id="EditData" role="dialog">
	<div class="modal-dialog">
    	...
    	<!-- Modal content-->
      	<div class="modal-content">
		  	<form id="editdata" name="editdata" method="post" enctype="multipart/form-data" action="operations/edit-scholarly-type.php">
        		<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
					<h4 class="modal-title">Edit Scholarly Type</h4>
				</div>
				<div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
...
<!-- Confirm Delete Modal -->
  <div class="modal fade" id="ConfirmDelete" role="dialog">
    <div class="modal-dialog">
      ...
      <!-- Modal content-->
      <div class="modal-content">
        <form action="operations/delete-scholarly-type.php" method="post" class="form-horizontal" enctype="multipart/form-data">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Are You Sure?</h4>
        </div>
        <div class="modal-body">
          <p>WARNING! Are you sure to delete this scholarly type?</p>
          <input type="hidden" name="oldid" id="oldid" value=""/>
        </div>
        <div class="modal-footer">

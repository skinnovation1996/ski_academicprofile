...
<head>
	...
	<title>Popular Articles - Academic Profile Student</title>
...
<div class="wrapper">
    ...
    -->
    	...
    	<div class="sidebar-wrapper">
            ...
            <?php $navactive = 2; include("assets/php/Student-navbar.php");?>
    	</div>
    </div>
        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="popular-articles.php">Popular Articles</a>
                </div>
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-left">
                        <li>
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
								<p class="hidden-lg hidden-md">Popular Articles</p>
                            </a>
                        </li>
                    </ul>
                            ...
                            <div class="content table-responsive">
                                ...
                                <table id="tlist" class="table table-hover table-striped">
                                    <thead>
                                    	...
                                    	<th width="45%" style="text-align:center">Article Title</th>
                                        <th width="40%" style="text-align:center">Author</th>
                                        <th width="10%" style="text-align:center">Platform</th>
                                        <th width="10%" style="text-align:center">Actions</th>
                                    </thead>
                                    <tbody>
                                    <button type= "button" data-toggle="modal" data-target="#AddData" class="add-data btn btn-success btn-sm">+ Add New Popular Article</button>
                                    <?php
                                        $sql = mysqli_query($conn, "SELECT * from tbl_popular_article WHERE article_owner='$login_session' AND super_owner='$login_super_owner'");
                                        $rows = mysqli_num_rows($sql);
                                              
                                        if($rows){
                                            $count = 1;
                                            while($row=mysqli_fetch_array($sql)){
                                                switch($row['article_platform']){
                                                    case "0": $platform = "Newspaper"; break;
                                                    case "1": $platform = "Magazine"; break;
                                                    case "2": $platform = "Internet Website"; break;
                                                    case "3": $platform = "Books"; break;
                                                    case "4": $platform = "Social Media"; break;
                                                    default: $platform = "Others";
                                                }
                                        ...
                                        <tr>
                                            ...
                                            <td><button type="button" data-toggle="modal" data-id="<?php echo $row['id'];?>" data-title="<?php echo $row['article_title'];?>" data-author="<?php echo $row['article_author'];?>" 
                                            data-platform="<?php echo $row['article_platform'];?>" data-owner="<?php echo $row['article_owner'];?>" data-file="<?php echo $row['article_file'];?>" data-target="#EditData" class="edit-data btn btn-primary btn-sm">EDIT</button>
                                            <a class="btn btn-success btn-sm" role="button" <?php 
                                            if($row['article_file'] == NULL){ 
                                                echo "disabled";
                                            }
                                            else{
                                                $file = $row['article_file'];
                                                echo "href='uploads/articles/$file'";
                                            }
                                            ?>>DOWNLOAD</a>
...
<div class="modal fade" id="AddData" role="dialog">
	<div class="modal-dialog">
    	...
    	<!-- Modal content-->
      	<div class="modal-content">
		  	<form id="adddata" name="adddata" method="post" enctype="multipart/form-data" action="operations/add-popular-article.php">
        		<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
					<h4 class="modal-title">Add Popular Article</h4>
				</div>
				<div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Article Title (HTML Tags Allowed)</label>
...
<div class="modal fade" id="EditData" role="dialog">
	<div class="modal-dialog">
    	...
    	<!-- Modal content-->
      	<div class="modal-content">
		  	<form id="editdata" name="editdata" method="post" enctype="multipart/form-data" action="operations/edit-popular-article.php">
        		<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
					<h4 class="modal-title">Edit Popular Article</h4>
				</div>
				<div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
...
<!-- Confirm Delete Modal -->
  <div class="modal fade" id="ConfirmDelete" role="dialog">
    <div class="modal-dialog">
      ...
      <!-- Modal content-->
      <div class="modal-content">
        <form action="operations/delete-popular-article.php" method="post" class="form-horizontal" enctype="multipart/form-data">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Are You Sure?</h4>
        </div>
        <div class="modal-body">
          <p>WARNING! Are you sure to delete this popular article?</p>
          <input type="hidden" name="oldid" id="oldid" value=""/>
        </div>
        <div class="modal-footer">

...
<head>
	...
	<title>Add Teacher - Academic Profile Super Admin</title>
        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="teachers.php"><<</a><a class="navbar-brand" href="add-teacher.php">Add New Teacher</a>
                </div>
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-left">
                        <li>
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
								<p class="hidden-lg hidden-md">Add New Teacher</p>
                            </a>
                        </li>
                    </ul>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Add New Teacher</h4>
                            </div>
                            <div class="content table-responsive">
                                <?php if($successmsg != NULL){ ?>
                                    ...
                                    <?php } ?>
                                <form id="adddata" name="adddata" method="post" enctype="multipart/form-data" action="operations/add-teacher.php">
                                    <div class="row">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="plan" id="plan" class="form-control">
                                                    <?php $sql2 = mysqli_query($conn, "select * from tbl_plans WHERE plan_type='Teacher'");
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="department" id="department" class="form-control" placeholder="Department/Faculty..." required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>School/Institute/University</label>
                                                <input type="text" name="university" id="university" class="form-control" placeholder="School/Institute/University..." required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">

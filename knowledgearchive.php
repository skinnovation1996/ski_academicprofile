...
<head>
  ...
  <title>Knowledge Archive - <?php echo $user_name;?> - Academic Profile Management</title>
...
<body>
  ...
  <header id="header">
    ...
    <div class="profile">
      ...
      <nav class="nav-menu">
        <h2 class="text-light">Knowledge Archive</h2>
        <ul>
  ...
  <main id="main">
    ...
    <section id="knowledgearchive" class="about">
      <div class="container">
        ...
        <div class="row">
            <table id="tlist" class="table table-hover table-striped" data-aos="fade-up">
                ...
                <tbody>
                    <?php
                    $knwlSQL = mysqli_query($conn, "SELECT * FROM tbl_knowledge WHERE super_owner='$super_owner' ORDER BY knowledge_date DESC");
